        ...
        success: function (response) {
          let arr = [];
            ...
            //   html += '<div class="todos">';
              ...
              html += '<ul style="padding-right:5px" class="list todo-list">';
              html += '<button class="btn-pill btn-dark btn-xs">'+response[i].sprintpoint+'</button>';
              html += '</ul>';
              html += '<div class="customers">';
              html += '<ul>';
              html += '<li><button data-id="'+response[i].id+'" data-status="'+response[i].status+'" data-judul="'+response[i].judul+'" data-priority="'+response[i].priority+'" data-due_date="'+response[i].due_date+'" data-issues="'+response[i].issues+'"  data-sprintpoint="'+response[i].sprintpoint+'" onclick="detail()" class="view_data btn btn-pill btn-outline-info btn-xs" data-toggle="modal" data-target="#viewdata" type="button" title=""><i class="fa fa-eye"></i> </button>';
              html += '<button data-id="'+response[i].id+'" data-status="'+response[i].status+'" data-judul="'+response[i].judul+'" data-priority="'+response[i].priority+'" data-due_date="'+response[i].due_date+'" data-issues="'+response[i].issues+'"  data-sprintpoint="'+response[i].sprintpoint+'" onclick="edit()" class="edit_data btn btn-pill btn-outline-warning btn-xs" data-toggle="modal" data-target="#editdata" type="button" title=""><i class="fa fa-paperclip"></i> </button>';
              html += '<button data-id="'+response[i].id+'" data-status="'+response[i].status+'" data-judul="'+response[i].judul+'" data-priority="'+response[i].priority+'" data-due_date="'+response[i].due_date+'" data-issues="'+response[i].issues+'"  data-sprintpoint="'+response[i].sprintpoint+'" onclick="cancel()" class="cancel_data btn btn-pill btn-outline-danger btn-xs" data-bs-toggle="modal" data-bs-target="#canceldata" type="button" title=""><i class="fa fa-trash"></i> </button>';
              html += '</li>';
              html += '</ul>';
              html += '</div>';
              html += '</div>';
