...
<div>
    <div class="logo-wrapper">
        <a href="{{ route('dashboard') }}">
            {{-- <img class="img-fluid for-light" src="{{ url('cuba') }}/assets/images/logo/logo.png" alt="">
            <img class="img-fluid for-dark" src="{{ url('cuba') }}/assets/images/logo/logo_dark.png" alt=""> --}}
        </a>
