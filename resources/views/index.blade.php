            ...
            <div class="col-xl-4 col-lg-12 xl-50 morning-sec box-col-12">
                <div class="card profile-greeting">
                    <div class="card-body pb-0">
                        ...
                        <div class="cartoon"><img class="img-fluid" src="{{ url('cuba') }}/assets/images/dashboard/cartoon.png"
                                alt=""></div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                src="{{ url('cuba') }}/assets/images/dashboard/update/1.jpg" alt="">
                            <div class="media-body">
                        ...
                        <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                src="{{ url('cuba') }}/assets/images/dashboard/update/2.jpg" alt="">
                            <div class="media-body">
                        ...
                        <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                src="{{ url('cuba') }}/assets/images/dashboard/update/3.jpg" alt="">
                            <div class="media-body">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle mb-3"
                                                        src="{{ url('cuba') }}/assets/images/appointment/app-ent.jpg"
                            ...
                            <div class="media-body">
                                <div class="d-flex mb-3">
                                    <div class="inner-img"><img class="img-fluid"
                                            src="{{ url('cuba') }}/assets/images/notification/1.jpg" alt="Product-1"></div>
                                    <div class="inner-img"><img class="img-fluid"
                                            src="{{ url('cuba') }}/assets/images/notification/2.jpg" alt="Product-2"></div>
                        ...
                        <div class="header-top">
                            ...
                            <div class="card-header-right-icon">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="#">Year</a><a class="dropdown-item"
                                            href="#">Month</a><a class="dropdown-item" href="#">Day</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="chat">
                            <div class="media left-side-chat">
                                <div class="media-body d-flex">
                                    <div class="img-profile"> <img class="img-fluid" src="{{ url('cuba') }}/assets/images/user.jpg"
                                            alt="Profile"></div>
                                    <div class="main-chat">
                                        <div class="message-main"><span class="mb-0">Hi deo, Please send me
                                                link.</span></div>
                                        <div class="sub-message message-main"><span class="mb-0">Right Now</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="media right-side-chat">
                                ...
                                <div class="media-body text-end">
                                    <div class="message-main pull-right"><span class="mb-0 text-start">How can do for
                                            you</span>
                            ...
                            <div class="media right-side-chat">
                                <div class="media-body text-end">
                                    <div class="message-main pull-right"><span class="loader-span mb-0 text-start"
                                            id="wave"><span class="dot"></span><span
                                                class="dot"></span><span class="dot"></span></span></div>
                                </div>
                            </div>
