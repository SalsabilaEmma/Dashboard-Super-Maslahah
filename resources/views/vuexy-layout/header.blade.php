            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="{{ url('vuexy') }}/app-assets/images/pages/eCommerce/1.png" alt="donuts"
                                    width="62">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="{{ url('vuexy') }}/app-assets/images/pages/eCommerce/7.png" alt="donuts"
                                    width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="{{ url('vuexy') }}/app-assets/images/pages/eCommerce/2.png" alt="donuts"
                                    width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="{{ url('vuexy') }}/app-assets/images/pages/eCommerce/3.png" alt="donuts"
                                    width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="{{ url('vuexy') }}/app-assets/images/pages/eCommerce/5.png" alt="donuts"
                                    width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    <div class="media-left">
                                        <div class="avatar"><img
                                                src="{{ url('vuexy') }}/app-assets/images/portrait/small/avatar-s-15.jpg"
                                ...
                                <div class="media d-flex align-items-start">
                                    <div class="media-left">
                                        <div class="avatar"><img
                                                src="{{ url('vuexy') }}/app-assets/images/portrait/small/avatar-s-3.jpg"
                                                alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="media-body">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John
                                ...
                                class="round"
                                src="{{ url('vuexy') }}/app-assets/images/portrait/small/avatar-s-11.jpg"
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                ...
                <div class="d-flex">
                    <div class="mr-75"><img src="{{ url('vuexy') }}/app-assets/images/icons/xls.png"
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="mr-75"><img src="{{ url('vuexy') }}/app-assets/images/icons/jpg.png"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="mr-75"><img src="{{ url('vuexy') }}/app-assets/images/icons/pdf.png"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="mr-75"><img src="{{ url('vuexy') }}/app-assets/images/icons/doc.png"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img
                            src="{{ url('vuexy') }}/app-assets/images/portrait/small/avatar-s-8.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img
                            src="{{ url('vuexy') }}/app-assets/images/portrait/small/avatar-s-1.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img
                            src="{{ url('vuexy') }}/app-assets/images/portrait/small/avatar-s-14.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img
                            src="{{ url('vuexy') }}/app-assets/images/portrait/small/avatar-s-6.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
